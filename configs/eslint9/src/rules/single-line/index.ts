 ...
 */
export const singleLineRules: Record<string, Rule.RuleModule> = {'prefer-single-line-call': preferSingleLineCall, 'prefer-single-line-control': preferSingleLineControl, 'prefer-single-line-if': preferSingleLineIf}
