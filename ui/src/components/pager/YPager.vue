...
const props = withDefaults(defineProps<YPagerProps>(), {modelValue: () => Pw.DEFAULT_MAX, pr: null, maxPage: 6, total: 10})
...
const modelOffset = computed({get: () => 1 + (_modelValue.value.o ?? 0), set: v => { _modelValue.value = {...props.modelValue, o: v - 1} }})
</script>
